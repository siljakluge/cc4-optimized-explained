...
\begin{itemize}
  \item \textbf{Restore-only response}: Remove is too slow against privilege escalation and does not remove malicious files. Restore is the reliable eviction path.
