"""
nodes.py — Graph Node Classes for CybORG Network Representation

This module defines the core graph node types used in the observation graph, including
detailed system, connection, internet, and file representations.

Classes:
- Node: Abstract base class with feature vector extraction and hashing
- SystemNode: Hosts like servers, routers, and users (includes OS and architecture info)
- ConnectionNode: Processes with communication roles (includes decoy and suspicious flags)
- InternetNode: Dummy node representing external internet
- FileNode: File-level observables, usually related to malware

Function:
- init_decoy: Factory function for instantiating predefined decoy processes
"""
