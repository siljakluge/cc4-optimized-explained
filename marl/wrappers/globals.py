"""
globals.py — Constants and Environment Parameters for Graph-Based CybORG Agents

This file defines global constants and mappings used throughout the RL pipeline, including:

- Subnet and router topology for the enterprise network
- Access control policies between routers and subnets
- Agent-to-subnet mapping (MY_SUBNETS)
- Action types (node, edge, global) and maximum values for action dimensions

Used to define the shape of observations, action masks, and subnet connectivity for PPO training.
"""
