...
class PPOMemory:
    ...
    def remember(self, s,a,v,p,r,t, h_r, h_v):
        '''
    ...
    def get_batches(self):
        ...
        return self.s, self.a, self.v, \
            self.p, self.r, self.t, self.h_r, self.h_v, batch_idxs
...
class MultiPPOMemory:
    ...
    def get_batches(self):
        ...
        for mem in self.mems:
            ...
            all_r.extend(mem.r)
            all_t.extend(mem.t)
            all_h_r.extend(mem.h_r)
            all_h_v.extend(mem.h_v)
        ...
        return all_s, all_a, all_v, all_p, all_r, all_t, all_h_r, all_h_v, batch_tensors
